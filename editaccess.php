        ...
        <form name="registro" action="atualizaccess.php" method="post" enctype="multipart/form-data">
           <div class="form-row">
                 <div class="form-group col-md-2">
                    <label>CPF:</label><input class="form-control" type="text" name="cpf" id="cpf" size="14" value="<?php echo $cpf?>" maxlength="14" required class="form-control" data-mask-for-cpf-cnpj/>
                 </div>
                 <div class="form-group col-md-3">
                    <label>Motorista:</label><input type="text" name="motorista" id="motorista" size="30" value="<?php echo $motorista?>" required class="form-control"/>
                 </div>
               <div class="form-group col-md-2">
                   <label>CNH:</label><input type="text" name="cnh" size="15" maxlength="15" id="cnh" value="<?php echo $cnh?>" required class="form-control"/> 
               </div>
               <div class="form-group col-md-2">
                <label>Val. CNH:</label><input type="date" name="valcnh" size="10" id="valcnh" value="<?php echo $valcnh?>" required class="form-control"/>   
               </div>
               <div class="form-group col-md-1">
                      <label>Cat CNH:</label><input type="text" size="1" maxlength="1" name="catcnh" id="catcnh" onkeyup="maiuscula(this)" value="<?php echo $catcnh?>" required class="form-control"/>
               </div>
               <div class="form-group col-md-2">
                   <label>Telefone:</label> <input type="text" name="fone" size="15" maxlength="15" id="tel" required class="form-control" onkeypress="$(this).mask('(00) 0 0000-0000 / 0 0000-0000');" value="<?php echo $fone?>">
               </div>
           </div>
              <div class="form-row">
                <div class="form-group col-md-1">
                ...
                <div class="form-group col-md-2">
                    <label>  Placa Cavalo/UF: </label><input type="text" name="placacv" id="placacav" size="10" value="<?php echo $placacv?>" required class="form-control"/>
                </div>
                <div class="form-group col-md-2">
                    <label>  Placa Carreta/UF: </label><input type="text" name="placac" id="placacar" size="10" value="<?php echo $placac?>" required class="form-control"/>
                </div>
                <div class="form-group col-md-2">
                  <label> Vendor:</label> <input type="text" name="vendor" id="vendor" size="10" value="<?php echo $vendor?>" required class="form-control"/>   
                </div>
                <div class="form-group col-md-4">
                 <label>  Transportadora:</label> <input type="text" name="transp" id="transp" size="30" value="<?php echo $transp?>" required class="form-control"/>  
                </div>
                <div class="form-group col-md-1">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                    <label> Cliente:</label><input type="text" id="cliente" name="cliente" size="30" value="<?php echo $cliente?>" required class="form-control"/>
                </div>
                <div class="form-group col-md-2">
                    <label>Data:</label><input name="data" id="data" type="date" value="<?php echo $data?>" class="form-control"/>
                </div>
                <div class="form-group col-md-2">
                    <label>Entrada Patio:</label><input name="entradaPatio" id="horapatio" type="time" value="<?php echo $entradaPatio?>" class="form-control"/>  
                </div>
                <div class="form-group col-md-2">
                    <label>Entrada Portaria:</label><input name="entradaPor" type="time" value="<?php echo $entradaPor?>" class="form-control"/>   
                </div>
                <div class="form-group col-md-2">
                    <label>Operação</label> <select name="operacao" id="operacao" class="form-control">
             ...
             <div class="form-row">
                <div class="form-group col-md-2">
                    <label>Tipo Cam.:</label> <select name="tipocam" id="tipocam" class="form-control">
                                <option value="<?php echo $tipocam?>" selected><?php echo $tipocam?></option>
                ...
                <div class="form-group col-md-2">
                 ...
                 <div class="form-group col-md-2">
                     <label> Nº Pedido:</label> <input type="text" name="pedido" size="12" value="<?php echo $pedido?>" required class="form-control"/>
                 </div>
                <div class="form-group col-md-2">
              ...
              <div class="form-row">
                  ...
                  <div class="form-check form-check-inline">
                      <input type="checkbox" class="form-check-input" name="epi[]"  value="Capacete" <?php foreach ($epi as $valor){if($valor == 'Capacete'){ echo "checked";}} ?>/>
                    <label class="form-check-label" for="epi[]">Capacete</label>
                  </div>
                   <div class="form-check form-check-inline">
                       <input type="checkbox" class="form-check-input" name="epi[]" value="Oculos" <?php foreach ($epi as $valor){if($valor == 'Oculos'){echo "checked";}}?>/>
                    <label class="form-check-label" for="epi[]">Oculos</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input type="checkbox" class="form-check-input" name="epi[]" value="Sapato Fechado" <?php foreach ($epi as $valor) {if($valor == 'Sapato Fechado'){ echo "checked";}} ?>/>
                    <label class="form-check-label" for="epi[]">Sapato Fechado</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input type="checkbox" class="form-check-input" name="epi[]" value="Faixa Refletiva" <?php foreach ($epi as $valor) {if($valor == 'Faixa Refletiva'){ echo "checked";}} ?>/>
                    <label class="form-check-label" for="epi[]">Faixa Refletiva</label>
                   </div>
                   <div class="form-check form-check-inline">
                       <input type="checkbox" class="form-check-input" name="epi[]" value="Nenhum" <?php foreach ($epi as $valor) {if($valor == 'Nenhum'){ echo "checked";}} ?>/>
                    <label class="form-check-label" for="epi[]">Nenhum</label>
                   </div>
                  </div>
              <div class="form-group col-md-3">
                  <label> OBS.:</label> <input type="text" name="obs" size="40" value="<?php echo $obs?>" class="form-control"/>
              </div>
             </div>
             <div class="form-row">
